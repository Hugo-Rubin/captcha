...
namespace Core.Logic.ImageQuantizer.Quantizers.MedianCut
{
    ...
    public class MedianCutQuantizer : BaseColorCacheQuantizer
    {
        ...
        private void SplitCubes(Int32 colorCount)
        {
            ...
            foreach (var cube in cubeList.TakeWhile(cube => newCubes.Count < colorCount))
            {
            ...
            foreach (var medianCutCube in newCubes)
            {
        ...
        protected override List<Color> OnGetPaletteToCache(Int32 colorCount)
        {
            ...
            var initalMedianCutCube = new MedianCutCube(UniqueColors.Keys);
