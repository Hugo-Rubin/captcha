...
namespace Core.Logic.ImageQuantizer.Extensions
{
    /// <summary>
    ...
    public static partial class Extend
    {
        ...
        public static Byte GetBitDepth(this PixelFormat pixelFormat)
        {
            switch (pixelFormat)
            {
                ...
                default:
                    var message = string.Format("A pixel format '{0}' not supported!", pixelFormat);
        ...
        public static UInt16 GetColorCount(this PixelFormat pixelFormat)
        {
            ...
            {
                var message = string.Format("Cannot retrieve color count for a non-indexed format '{0}'.",
                                               pixelFormat);
                throw new NotSupportedException(message);
            }
        ...
        /// </summary>
        /// <param name="pixelFormat"> The pixel format. </param>
        /// <returns> <c>true</c> if the specified pixel format is indexed; otherwise, <c>false</c> . </returns>
        public static Boolean IsIndexed(this PixelFormat pixelFormat)
        {
            return pixelFormat == PixelFormat.Indexed;
        }
        ...
        public static PixelFormat GetFormatByColorCount(Int32 colorCount)
        {
            ...
            {
                var message = string.Format("A color count '{0}' not supported!", colorCount);
                throw new NotSupportedException(message);
            }

            var result = PixelFormat.Format1bppIndexed;
        ...
        /// </summary>
        /// <param name="pixelFormat"> The pixel format. </param>
        /// <returns> <c>true</c> if the specified pixel format has an alpha channel; otherwise, <c>false</c> . </returns>
        public static Boolean HasAlpha(this PixelFormat pixelFormat)
        {
            return (pixelFormat == PixelFormat.Alpha || pixelFormat  == PixelFormat.PAlpha);
        }
        ...
        /// </summary>
        /// <param name="pixelFormat"> The pixel format. </param>
        /// <returns> <c>true</c> if [is deep color] [the specified pixel format]; otherwise, <c>false</c> . </returns>
