    ...
    public class QuantizationHelper
    {
        ...
        internal static Color ConvertAlpha(Color color, out Int32 argb)
        {
            ...
            if (color.A < 255)
            {
                ...
                var colorFactor = Factors[color.A];
                var backgroundFactor = Factors[255 - color.A];
                var red = (Int32)(color.R * colorFactor + BackgroundColor.R * backgroundFactor);
                var green = (Int32)(color.G * colorFactor + BackgroundColor.G * backgroundFactor);
                var blue = (Int32)(color.B * colorFactor + BackgroundColor.B * backgroundFactor);
