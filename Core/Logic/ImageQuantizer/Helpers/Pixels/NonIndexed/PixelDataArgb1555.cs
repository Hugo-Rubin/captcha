...
namespace Core.Logic.ImageQuantizer.Helpers.Pixels.NonIndexed
{
    /// <summary>
    ...
    public struct PixelDataArgb1555 : INonIndexedPixel
    {
        ...
        [FieldOffset(0)]
        private Byte blue; // 00 - 04
        [FieldOffset(0)]
        private UInt16 green; // 05 - 09
        [FieldOffset(1)]
        private Byte red; // 10 - 14
        [FieldOffset(1)]
        private Byte alpha; // 15
        ...
        public Int32 Alpha
        {
            get { return (alpha >> 7) & 0x1; }
        }

        public Int32 Red
        {
            get { return (red >> 2) & 0xF; }
        }

        public Int32 Green
        {
            get { return (green >> 5) & 0xF; }
        }
