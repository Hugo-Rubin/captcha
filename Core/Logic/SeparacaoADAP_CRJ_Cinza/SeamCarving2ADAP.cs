...
{
    public class SeamCarving2ADAP
    {
        private static int cont;
        private static ImgArray[] carac;
        private readonly int letras;
        private readonly bool naoSepararGrudado;
        private uint[][] custos;
        private int interval;
        private int qtdeClustersEsperados;
        private int[][] seams;

        public SeamCarving2ADAP(int tamanhoDaSaidaEsperada, int interval = 0, bool naoSepararGrudado = false)
        {
            letras = tamanhoDaSaidaEsperada;
            this.interval = interval;
            this.naoSepararGrudado = naoSepararGrudado;
        }
        ...
        public ImgArray CarveAndDrawCarves(ImgArray cdata)
        {
            //cdata = cdata.RemoveWhiteBorders(2, 2);
        ...
        private void SeparaCharGrudado(int[] width, IList<bool> filledCluster)
        {
            ...
            var num = 0;
            var currentIndex = 0;
            var sc = new[] { new SeamCarving2ADAP(2), new SeamCarving2ADAP(2) };
            ...
            do
            {
                ...
                ch[num] = sc[num].CarveAndDrawCarves(new ImgArray(ch[num]).RemoveWhiteBorders(2, 2)).ToBitmap();
