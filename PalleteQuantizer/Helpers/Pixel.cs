...
using PalleteQuantizer.Helpers.Pixels;
using PalleteQuantizer.Helpers.Pixels.Indexed;
using PalleteQuantizer.Helpers.Pixels.NonIndexed;
    ...
    public class Pixel : IDisposable
    {
        ...
        internal Type GetIndexedType(PixelFormat pixelFormat)
        {
            switch (pixelFormat)
            {
                ...
                default:
                    String message = String.Format("This pixel format '{0}' is either non-indexed, or not supported.",
                                                   pixelFormat);
        ...
        internal Type GetNonIndexedType(PixelFormat pixelFormat)
        {
            switch (pixelFormat)
            {
                ...
                default:
                    String message = String.Format("This pixel format '{0}' is either indexed, or not supported.",
                                                   pixelFormat);
                    throw new NotSupportedException(message);
            }
        }
