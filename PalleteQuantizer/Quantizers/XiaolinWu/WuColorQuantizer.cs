...
namespace PalleteQuantizer.Quantizers.XiaolinWu
{
    /// <summary>
    ///     Author:	Xiaolin Wu
    ...
    public class WuColorQuantizer : BaseColorQuantizer
    {
        ...
        private Boolean Cut(WuColorCube first, WuColorCube second)
        {
            ...
            Single maxRed = Maximize(first, Red, first.RedMinimum + 1, first.RedMaximum, cutRed, wholeRed, wholeGreen,
                                     wholeBlue, wholeWeight);
            Single maxGreen = Maximize(first, Green, first.GreenMinimum + 1, first.GreenMaximum, cutGreen, wholeRed,
                                       wholeGreen, wholeBlue, wholeWeight);
            Single maxBlue = Maximize(first, Blue, first.BlueMinimum + 1, first.BlueMaximum, cutBlue, wholeRed,
                                      wholeGreen, wholeBlue, wholeWeight);
