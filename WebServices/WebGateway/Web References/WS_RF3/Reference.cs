...
namespace WebGateway.WS_RF3 {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="OCRRF3Soap", Namespace="http://tempuri.org/")]
    public partial class OCRRF3 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public OCRRF3() {
            this.Url = global::WebGateway.Properties.Settings.Default.WebGateway_WS_RF3_OCRRF3;
        ...
        public string GetText([System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] zipFile, int w, int h, string token) {
        ...
        /// <remarks/>
        public void GetTextAsync(byte[] zipFile, int w, int h, string token) {
            this.GetTextAsync(zipFile, w, h, token, null);
        }
        
        /// <remarks/>
        public void GetTextAsync(byte[] zipFile, int w, int h, string token, object userState) {
