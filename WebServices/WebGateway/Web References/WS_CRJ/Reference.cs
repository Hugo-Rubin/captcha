...
namespace WebGateway.WS_CRJ {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="OCRCRJSoap", Namespace="http://tempuri.org/")]
    public partial class OCRCRJ : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public OCRCRJ() {
            this.Url = global::WebGateway.Properties.Settings.Default.WebGateway_WS_CRJ_OCRCRJ;
        ...
        public string GetText([System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] ImagemColorida, int w, int h, string Token) {
        ...
        /// <remarks/>
        public void GetTextAsync(byte[] ImagemColorida, int w, int h, string Token) {
            this.GetTextAsync(ImagemColorida, w, h, Token, null);
        }
        
        /// <remarks/>
        public void GetTextAsync(byte[] ImagemColorida, int w, int h, string Token, object userState) {
