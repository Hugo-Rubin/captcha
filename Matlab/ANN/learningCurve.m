function [error_train, error_val] = ...
    learningCurve(initial_nn_params, input_layer_size, hidden_layer_size, ...
                   num_labels, X, y, Xval, yVal, lambda)
...
Theta1 = zeros(1, m);
Theta2 = zeros(1, m);
nn_params = zeros(1, size(Theta1, 2) + size(Theta2, 2));
...
for i = 1:m
    ...
    fprintf('i = %d de %d\n', i, m);
    %nn_paramsI = [Theta1(1:i, :) ; Theta2(1:i, :)];
    [Theta1, Theta2] = trainANN(input_layer_size, hidden_layer_size, initial_nn_params, num_labels, X(1:i, :), y(1:i), lambda);
    nn_params = [Theta1(:) ; Theta2(:)];
    error_train(i) = nnCostFunction(nn_params, input_layer_size, hidden_layer_size, ...
                   num_labels, X(1:m, :), y(1:m, :), 0);
